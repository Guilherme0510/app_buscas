        ...
        <div className="row">
          ...
          <div className="col-md-6 section-escolha">
            <div className="justify-content-between card-escolha">
              <img src={require('../images/icon1.png')} alt="" width='20%' height='50%' />
              <p>
            ...
            <div className="justify-content-between card-escolha">
              <img src={require('../images/icon2.png')} alt="" width='20%' height='50%' />
              <p>
                Soluções adaptadas especificamente às necessidades do seu
                negócio
              </p>
            ...
            <div className="justify-content-between card-escolha">
              <img src={require('../images/icon3.png')} alt=""  width='20%' height='50%'/>
              <p>
                Soluções adaptadas especificamente às necessidades do seu
                negócio
              </p>
